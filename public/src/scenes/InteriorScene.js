...
export default class InteriorScene extends Phaser.Scene {
  ...
  /**
   * Initializes the interior scene with the given data.
   *
   * @param {object} data - Data to initialize the scene with.
   * @property {string} data.villageId - The ID of the village.
   * @property {string} data.houseOwnerId - The ID of the house owner.
   */
  init(data) {
